...
export function Categories() {
  const featuredGames = [
    ...
    },
    {
      ...
      description: "Build train routes across countries in this engaging family game",
      players: "2-5",
      duration: "30-60",
      difficulty: "Easy",
      rating: 4.8,
    },
    {
      ...
      description: "Work together to save humanity from global diseases",
      players: "2-4",
      duration: "45-60",
      difficulty: "Medium",
      rating: 4.7,
      ...
      <section className="bg-gradient-to-br from-primary/20 via-secondary/30 to-accent/20 py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl mb-6 text-foreground">Featured Games</h1>
            <p className="text-lg text-muted-foreground">
              Discover our most popular board games. Click on a game to learn more and check availability!
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredGames.map((game) => (
            <Link key={game.id} to={`/en/board-games/categories/${game.slug}`}>
        ...
        <div className="mt-16 bg-muted/50 border border-border rounded-lg p-8 text-center max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            We have over 100 games in our collection! Visit us or contact our staff for personalized game recommendations based on your preferences.
          </p>
          <Link to="/en/book">
