...
export function Drinks() {
  const categories = [
    ...
    },
    {
      ...
      icon: Wine,
      items: [
        { name: "Tuborg Squash Orange", price: "25 DKK" },
        { name: "Tuborg Squash Sports Water", price: "25 DKK" },
        { name: "Tuborg Squash Peach", price: "25 DKK" },
        { name: "Lemonade Rhubarb", price: "25 DKK" },
        { name: "Lemonade Elderflower", price: "25 DKK" },
        { name: "Lemonade Passionfruit", price: "25 DKK" },
        { name: "Lemonade Raspberry", price: "25 DKK" },
    ...
    <div>
      ...
      <section className="container mx-auto px-4 pb-16">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl mb-6 text-foreground">Something for the Throat and Palate</h1>
          <p className="text-lg text-muted-foreground">
            A little something for the throat and palate while you play
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          <Card className="border-2">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>• All drinks and snacks can be ordered at the counter or via our staff</p>
              <p>• We deliver directly to your table</p>
              <p>• Vegetarian and vegan options are available</p>
              <p>• Please let us know about any allergies or dietary restrictions</p>
              <p>• All prices include VAT</p>
              <p>• Menu items depend on stock availability</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-primary to-accent py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl mb-4">Ready to play and enjoy?</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            Book your table and we'll make sure you're well-rested and hydrated throughout your gaming session!
          </p>
          <Link to="/en/book">
