    ...
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              The ultimate cooperative VR experience! Together you must figure out how to defuse the bomb before time runs out!
            </p>
          </div>
          ...
          <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              <h3 className="text-2xl mb-2">An unforgettable experience</h3>
              <p className="text-white/90">With the latest technology, you're drawn into the virtual world</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl mb-4 text-foreground">How does it work?</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A nerve-wracking task that tests your ability to communicate and cooperate! <br></br>
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="text-center">
              ...
              <h3 className="mb-2">Get an introduction</h3>
              <p className="text-sm text-muted-foreground">
                Get an overview of the game and the equipment
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="mb-2">Step into virtual reality</h3>
              <p className="text-sm text-muted-foreground">
                One person sees the bomb, the others see the manual
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="mb-2">Defuse the bomb!</h3>
              <p className="text-sm text-muted-foreground">
          ...
          <Card className="bg-accent/20 border-2 border-accent">
            <CardContent className="pt-6">
              <p className="text-center text-muted-foreground">
                <strong>The challenge:</strong> One person sees the bomb, the others see the manual. Describe what you see and follow the instructions. One wrong move and... BOOM! 💥
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Perfect for corporate events and team building! Requires strong communication
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Your pulse rises with the clock – can you handle the pressure?!
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Choose between different bomb missions, with varying difficulty levels.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Each round only takes 5-10 minutes – play again and beat the record!
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl mb-4 text-foreground">Price & Details</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="border-2 hover:border-primary/50 transition-all">
              <CardHeader className="text-center">
                ...
                <CardDescription>30 minutes in virtual reality</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <ul className="space-y-2 mb-6 text-sm text-muted-foreground">
                  ...
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full"></div>
                    A short introduction before the game
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full"></div>
                    2-4 players
            ...
            <Card className="border-2 border-primary/50 relative">
              ...
              <CardHeader className="text-center">
                ...
                <CardDescription>60 minutes of play time</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center mb-6">
                  <div className="text-4xl mb-2 text-primary">350 DKK</div>
                  <p className="text-sm text-muted-foreground">
                    per group (2-4 people) <span className="line-through">400 DKK</span>
                  </p>
                </div>
                <ul className="space-y-2 mb-6 text-sm text-muted-foreground">
                  <li className="flex items-center gap-2">
          ...
          <Card className="mt-8 border-2">
            ...
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              <p>• Recommended for ages 12+ (younger players are welcome with adult supervision)</p>
