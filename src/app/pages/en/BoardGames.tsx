...
export function BoardGames() {
  const categories = [
    {
      ...
      description: "Tactical strategy games to challenge your brain.",
      icon: "🧠",
      count: "150+",
  ...
  const stats = [
    { icon: Users, label: "Available games", value: "100+" },
    { icon: Clock, label: "Play time", value: "15 min - 4 hours" },
    { icon: TrendingUp, label: "New games every month", value: "10+" },
  ];
    ...
    <div>
      ...
      <section className="relative bg-gradient-to-br from-primary/20 via-secondary/30 to-accent/20 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl mb-6 text-foreground">Board Game Collection</h1>
            <p className="text-lg text-muted-foreground mb-8">
              Explore our 100+ games. From quick party games to strategic games, we have something for every player.
            </p>
          </div>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl mb-4 text-foreground">Game Categories</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Browse our different games to find your new favorite.
          </p>
        </div>
            ...
            <Card key={index} className="overflow-hidden hover:shadow-xl transition-all duration-300 group border-2 hover:border-primary/50">
              <div className="relative h-64">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <div className="text-sm text-white/70">{category.count} games</div>
                </div>
              </div>
            </Card>
          ))}
        ...
        <div className="text-center">
          <Link to="/en/board-games/categories">
      ...
      <section className="bg-muted/50 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">An easy way to start playing</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Reserve your spot online or just drop by</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary text-white rounded-full flex items-center justify-center text-2xl mx-auto mb-4">
                2
              </div>
              <h3 className="mb-2">Choose your game</h3>
              <p className="text-sm text-muted-foreground">Browse our selection or ask for recommendations</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary text-white rounded-full flex items-center justify-center text-2xl mx-auto mb-4">
                3
              ...
              <p className="text-sm text-muted-foreground">Our staff can teach you any game</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary text-white rounded-full flex items-center justify-center text-2xl mx-auto mb-4">
                4
              </div>
              <h3 className="mb-2">Enjoy!</h3>
              <p className="text-sm text-muted-foreground">Play for as long as you like</p>
            </div>
          </div>
        </div>
      </section>
