    ...
    <div>
      ...
      <section className="container mx-auto px-4 pb-16">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            We're located at Nørre Voldgade 18, right in the heart of Copenhagen
          </p>
        </div>
      </section>
            ...
            <CardContent className="p-0">
              ...
              <div className="relative w-full h-96 md:h-[600px] bg-muted flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <h3 className="text-xl mb-2">BoardGame Café</h3>
                  <p className="text-muted-foreground mb-4">
                    Nørre Voldgade 18, 1358 Copenhagen K
                  </p>
            ...
            <Card className="border-2 hover:border-primary/50 hover:shadow-lg transition-all">
              ...
              <CardContent>
                <CardDescription className="text-sm">
                  ...
                  Bike rack right across the street
                  <br />
                </CardDescription>
              </CardContent>
            </Card>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl mb-8 text-center text-foreground">Parking</h2>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-2">
                  Limited paid parking on Nørre Voldgade and surrounding streets, or we recommend the parking garage under Israels Plads.
                </p>
          ...
          <Card className="mt-6 bg-accent/10 border-2 border-accent/30">
            <CardContent className="pt-6">
              <p className="text-sm text-muted-foreground text-center">
                💡 <strong>Tip:</strong> We recommend using public transport or a bike when visiting Copenhagen.
                <br />
